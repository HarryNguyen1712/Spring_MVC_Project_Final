                                                        ...
                                                        <div class="weather-item">
                                                            <div class="container">
                                                                <div class="row row-cols-3">
                                                                    ...
                                                                    <div class="col">
                                                                        <p>${item.flightRoute.duration}</p>
                                                                        <p>${item.aircraft.name}</p>
                                                                    </div>
                                                                    <div class="col">
                                                                    ...
                                                                    <c:forEach var="item1"
                                                                        ...
                                                                        <div class="col">
                                                                            ...
                                                                            <br>
                                                                            <a href="flightCheck?departFlightId=${departFlight.id}&departSeatId=${departSeat.id}&returnFlightId=${item.id}&returnSeatId=${item1.id}" class="btn btn-outline-dark">
                                                                                    ${item1.price}$
                                                                            </a>
                                                                        </div>
                                                                    </c:forEach>
