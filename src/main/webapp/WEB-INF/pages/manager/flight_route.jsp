            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Add Flight Routes</div>
                        </div>
                            ...
                            <form:form id="formPromotion" class="card-body row" modelAttribute="flightRoute" method="get"
                                ...
                                <div class="col-lg-4 p-t-20">
                                        ...
                                        <select name="departureAirport.id" class=" form-control" required>
                                            ...
                                            <c:forEach  items="${airports}" var="item">
                                                <c:choose>
                                                    <c:when test="${flightRoute.departureAirport.id==item.id}">
                                ...
                                <div class="col-lg-4 p-t-20">
                                    ...
                                    <select name="destinationAirport.id" class=" form-control"  required>
                                        ...
                                        <c:forEach  items="${airports}" var="item">
                                            <c:choose>
                                                <c:when test="${flightRoute.destinationAirport.id==item.id}">
                                                    <option value="${item.id}" selected>${item.name} </option>
                                                </c:when>
                                                <c:otherwise>
                                                    <option value="${item.id}">${item.name}</option>
                                ...
                                <div class="col-lg-4 p-t-20">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" type="text" name="distance" value="${flightRoute.distance}" required>
                                ...
                                <div class="col-lg-6 p-t-20">
                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                        <input class="mdl-textfield__input" type="text" name="standardPrice" value="${flightRoute.standardPrice}" required>
...
<script src="${pageContext.request.contextPath}/resources-management/assets/plugins/duration/html-duration-picker.min.js"></script>
