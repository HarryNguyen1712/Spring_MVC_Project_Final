...
<div class="main">
    <div class="container b-container" id="b-container">
        <form:form modelAttribute="user" class="form" id="b-form" method="get" action="doRegister">
            ...
            <input class="form__input" name="fullName" type="text" placeholder="Name" required>
            <input class="form__input" name="birthday" type="date" placeholder="Birthday" max="2015-12-31" required>
            <select class="form__input" name="genderEnum" required>
                <option value="">Choose...</option>
                <c:forEach var="item" items="${genderList}">
                    <option value="${item}">${item}</option>
                </c:forEach>
            </select>
            <%--<select class="form__input" name="genderEntity" required>
                <option value="">Choose...</option>
            ...
            <input class="form__input" id="phone_number" name="phoneNumber" type="text" placeholder="Phone Number(10 digits)" pattern="[0-9]{10}" required>
            <input class="form__input" name="email" type="email" placeholder="Email" required>
            <c:if test="${requestScope.emailError == true}">
                <p style="color: red;font-style: italic">Email already exists!!</p>
            </c:if>
            <input class="form__input" id="password" name="password" type="password" placeholder="Password" onchange="validatePassword()" required>
            <input class="form__input" id="confirm_password" type="password" placeholder="Confirm Password" onchange="validatePassword()" required>
            <button class="form__button button submit">SIGN UP</button>
        </form:form>
    </div>
    <div class="container a-container" id="a-container">
        <form class="form" id="a-form" method="post" action="<c:url value="j_spring_security_check"/>">
