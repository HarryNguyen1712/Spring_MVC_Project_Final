            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">All Flight Routes</div>
                        </div>
                                        ...
                                        <div class="table-scrollable">
                                            <table class="table table-hover table-checkable order-column full-width" id="example4">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="center"> Standard price </th>
                                                ...
                                                <c:forEach items="${flightRouteList}" var="item" >
                                                    <tr class="odd gradeX">
                                                        <td class="center">${item.departureAirport.name}</td>
                                                        <td class="center">${item.destinationAirport.name}</td>
                                                        <td class="center">${item.duration.toHoursPart()}H${item.duration.toMinutesPart()}M</td>
                                                        <td class="center"><fmt:formatNumber value = "${item.distance}" minFractionDigits="0" type = "NUMBER" currencySymbol=""/> KM</td>
                                                        <td class="center"><fmt:formatNumber value = "${item.standardPrice}" minFractionDigits="0" type = "currency" currencySymbol="$"/></td>
                                                        <td class="center">
