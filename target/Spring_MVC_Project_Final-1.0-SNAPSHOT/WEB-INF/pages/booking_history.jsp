                                ...
                                <div class="card-box">
                                    <div class="card-head">
                                       <%-- <div style="width: 70%;" class="m-2 mb-0">
                                            <form:form modelAttribute="searchDate" action="booking_history" method="get" autocomplete="off">
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="datepicker date input-group p-0 shadow-sm" style="border-radius: 6rem" >
                                                            <input type="text" placeholder="Start date" class="form-control " id="startDate" name="startDate" style="border-radius: 6rem" />
                                                                &lt;%&ndash;<input type="text" placeholder="Start date" class="form-control py-4 px-4"  id="startDate" name="startDate" required >&ndash;%&gt;
                                                        </div>
                                                    </div>
                                                </div>
                                                <div style="display: inline-block">
                                                ...
                                                <tbody>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center"><a href="mailto:${item.email}">
                                                                ${item.email}</a></td>
                                                        <td class="center">${item.genderEnum}</td>
