                                    ...
                                    <div class="card-box">
                                        <div class="card-head">
                                            <div style="width: 70%;" class="m-2 mb-0">
                                                <form:form modelAttribute="searchDate" action="booking_history"
                                                        ...
                                                        <div class="mb-4">
                                                            <div class="datepicker date input-group p-0 shadow-sm"
                                                                ...
                                                                <input type="text" placeholder="Start date"
                                                                       ...
                                                                       name="startDate" style="border-radius: 6rem"/>
                                            ...
                                            <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
                                                ...
                                                <li class="mdl-menu__item"><i class="material-icons">assistant_photo</i>
                                                    <button id="pdf1" class="btn btn-danger">TO PDF</button>
                                                </li>
                                                <li>
                                                    <button id="csv" class="btn btn-info "
                                                            style="display: block; width: 100%">TO CSV
                                                    </button>
                                                </li>
                                            </ul>
                                        </div>
